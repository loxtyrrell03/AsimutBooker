                            ...
                            "daily_planning": _object_schema(
                                {
                                    ...
                                    "preferred_block_minutes": {"type": "integer", "enum": [0, 30, 60, 90, 120],
                                        "description": "Optional preferred session length; 0 means automatic. Never sacrifice good booked hours for this preference."},
                                    "preferred_rest_minutes": {"type": "integer", "minimum": 0, "maximum": 120, "multipleOf": 15,
                                        "description": "Optional break between practice sessions. Best effort only; it never blocks otherwise useful practice."},
                                    "prefer_fewer_room_changes": {"type": "boolean",
                                        "description": "Prefer fewer room changes only when booked hours and primary room/time quality are preserved."},
